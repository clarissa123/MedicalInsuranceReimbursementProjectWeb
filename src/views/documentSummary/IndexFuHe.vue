  ...
  <div class="documentSu">
      ...
      <div class="listBox">
        <div class="top">
          ...
          <div class="top-right" v-show="isCollapse">
            ...
            <el-button type="primary" @click="spDialogVisible = true" v-if="(flowStatus === 'WAIT_EXAMINE')"
              class="right-btn">审批</el-button>
            <el-button type="primary" @click="htDialogVisible = true" v-if="(flowStatus === 'EXAMINE_SUCCESS')"
              class="right-btn">回填业务系统</el-button>
          </div>
        </div>
    ...
    <el-dialog title="汇总审批" :visible.sync="spDialogVisible" width="20%" class="spD" center>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="spDialogVisible = false" type="primary" plain class="left-btn">取 消</el-button>
        <el-button type="primary" @click="subCheck" class="right-btn">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 回填业务系统 -->
  ...
  export default {
    ...
    methods: {
      ...
      excel() {
        ...
        const url = `${baseURL}/medicare/calculation/summary/excel/${this.dataId}`;
        const formStr =
